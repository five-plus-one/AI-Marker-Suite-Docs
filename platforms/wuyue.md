...
description: AI批改助手五岳阅卷适配器使用说明。支持wylkyj.com阅卷平台答题卡识别、Vue3响应式输入框分数填充、分小题评分功能。包含技术特点、操作流程和常见问题解答。
keywords: 五岳阅卷,AI批改,AI阅卷,自动批改,智能阅卷,wylkyj.com,答题卡识别,AI评分,自动提交,分小题评分,手写识别,在线阅卷助手
---
