...
export default defineConfig({
  lang: 'zh-CN',
  title: 'AI 批改助手',
  description: 'AI 批改助手 — 基于多模态 AI 的在线阅卷自动批改工具，支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育、润建学情、54学霸、九科星、慧阅卷、乐华阅卷、鑫考、慧学星、粤教翔云、云阅卷(好分数)、科耘阅卷和光大阅卷V2十九大平台。晚上挂机睡觉，早上起来全改完。',
  base: BASE,
  cleanUrls: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: '基于多模态 AI 的在线阅卷自动批改工具。支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育、润建学情、54学霸、九科星、慧阅卷、乐华阅卷、鑫考、慧学星、粤教翔云、云阅卷(好分数)、科耘阅卷和光大阅卷V2，自动识别手写答案并评分，三种批改模式，支持分小题评分和分数纠错。' }],
    ...
    ['meta', { name: 'twitter:description', content: '基于多模态 AI 的在线阅卷自动批改工具。支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育、润建学情、54学霸、九科星、慧阅卷、乐华阅卷、鑫考、慧学星、粤教翔云、云阅卷(好分数)、科耘阅卷和光大阅卷V2，三种批改模式，支持分小题评分和分数纠错。' }],
    ['meta', { name: 'twitter:image', content: `${SITE_URL}/img/1.png` }],

    // SEO: Additional Keywords
    ['meta', { name: 'keywords', content: 'AI批改,AI阅卷,自动批改,智能阅卷,智学网,七天网络,好分数,五岳阅卷,华翰云,光大阅卷,云阅卷,新教育,润建学情,54学霸,九科星,慧阅卷,乐华阅卷,鑫考,慧学星,粤教翔云,云阅卷好分数,科耘阅卷,光大阅卷V2,主观题批改,作文批改,Tampermonkey,油猴脚本,AI评分,在线阅卷助手,AI自动批改,智能阅卷助手,手写识别,AI作文评分,在线阅卷工具,自动批改脚本,阅卷效率工具,AI手写识别,自动评分系统,在线考试阅卷' }],

    // GEO: AI crawler hints
    ['meta', { name: 'ai-purpose', content: 'AI批改助手是一款Tampermonkey用户脚本，用于在智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育、润建学情、54学霸、九科星、慧阅卷、乐华阅卷、鑫考、慧学星、粤教翔云、云阅卷(好分数)、科耘阅卷和光大阅卷V2阅卷平台上自动批改主观题试卷' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      description: '基于多模态 AI 的在线阅卷自动批改工具，支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育、润建学情、54学霸、九科星、慧阅卷、乐华阅卷、鑫考、慧学星、粤教翔云、云阅卷(好分数)、科耘阅卷和光大阅卷V2。自动识别手写答案并评分，支持三种批改模式、双评仲裁、工作流配置、分小题评分和分数纠错。',
      url: SITE_URL,
      ...
      featureList: [
        ...
        '多平台支持：智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育、润建学情、54学霸、九科星、慧阅卷、乐华阅卷、鑫考、慧学星、粤教翔云、云阅卷(好分数)、科耘阅卷、光大阅卷V2',
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '目前支持智学网（zhixue.com）、七天网络（7net.cc / qt7.net）、好分数（haofenshu.com）、五岳阅卷（wylkyj.com）、华翰云（yunyuejuan.net）、光大阅卷（pj.yixx.cn）、云阅卷、新教育（xinjiaoyu.com）、润建学情（aisusheng.runjian.com）、54学霸（54xueba.cn）、九科星（marking.jkxjxw.com）、慧阅卷（web.17yuejuan.cn）、乐华阅卷（main.lhsvr.cn）、鑫考、慧学星（www.hxxai.com）、粤教翔云（rrtcp.gdedu.gov.cn）、云阅卷(好分数)（haofenshuyize.com）、科耘阅卷（kaoshi.keewing.com）和光大阅卷V2，通过适配器模式自动检测当前平台。',
          },
        },
        {
          '@type': 'Question',
