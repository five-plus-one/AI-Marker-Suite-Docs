...
export default defineConfig({
  lang: 'zh-CN',
  title: 'AI 批改助手',
  description: 'AI 批改助手 — 基于多模态 AI 的在线阅卷自动批改工具，支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育和润建学情。晚上挂机睡觉，早上起来全改完。',
  base: BASE,
  cleanUrls: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: '基于多模态 AI 的在线阅卷自动批改工具。支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育和润建学情，自动识别手写答案并评分，三种批改模式，支持分小题评分和分数纠错。' }],
    ...
    ['meta', { name: 'twitter:description', content: '基于多模态 AI 的在线阅卷自动批改工具。支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育和润建学情，三种批改模式，支持分小题评分和分数纠错。' }],
    ['meta', { name: 'twitter:image', content: `${SITE_URL}/img/1.png` }],

    // SEO: Additional Keywords
    ['meta', { name: 'keywords', content: 'AI批改,AI阅卷,自动批改,智能阅卷,智学网,七天网络,好分数,五岳阅卷,华翰云,光大阅卷,云阅卷,新教育,润建学情,主观题批改,作文批改,Tampermonkey,油猴脚本,AI评分,在线阅卷助手' }],

    // GEO: AI crawler hints
    ['meta', { name: 'ai-purpose', content: 'AI批改助手是一款Tampermonkey用户脚本，用于在智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育和润建学情阅卷平台上自动批改主观题试卷' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      description: '基于多模态 AI 的在线阅卷自动批改工具，支持智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育和润建学情。自动识别手写答案并评分，支持三种批改模式、双评仲裁、工作流配置、分小题评分和分数纠错。',
      url: SITE_URL,
      ...
      featureList: [
        ...
        '多平台支持：智学网、七天网络、好分数、五岳阅卷、华翰云、光大阅卷、云阅卷、新教育、润建学情',
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '目前支持智学网（zhixue.com）、七天网络（7net.cc / qt7.net / yj5.7net.cc）、好分数（haofenshu.com）、五岳阅卷（wylkyj.com）、华翰云（yunyuejuan.net）、光大阅卷（pj.yixx.cn）、云阅卷、新教育（xinjiaoyu.com）和润建学情（aisusheng.runjian.com），通过适配器模式自动检测当前平台。',
          },
        },
        {
          '@type': 'Question',
